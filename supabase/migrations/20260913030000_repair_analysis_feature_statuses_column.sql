-- Repair: migration 20260617000000 was recorded as applied but the
-- analysis_feature_statuses column on rekordbox_tracks did not land on the
-- remote schema. This also recreates the bulk RPC (from 20260913010000) so
-- its t.analysis_feature_statuses reference resolves correctly.
